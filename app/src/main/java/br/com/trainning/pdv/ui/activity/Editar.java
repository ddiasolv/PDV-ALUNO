...
//                new APIClient().getRestService().updateProduto(produto.getCodigoBarras(), produto.getDescricao(), produto.getUnidade(), produto.getPreco(), produto.getFoto(), produto.getAtivo(), callbackUpdateProduto);
